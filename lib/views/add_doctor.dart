...
class _CreateAccountPageState extends State<AddDoctorPage> {
  ...
  List<String> userExperiences = ["3 years", "5 years", "More"];
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    DropdownButtonFormField2<String>(
                                      ...
                                      validator: (value) {
                                        if (value == null) {
                                          return 'Please select field of specialization';
                                        }
                                        return null;
                                      },
                                      onChanged: (value) {
                                              ...
                                              showDialog(
                                                  ...
                                                  builder:
                                                      (BuildContext context) =>
                                                          ErrorDialog(
                                                            message:
                                                                'You are not authorized to set up a doctor account. Please contact support',
                                                          )).then((value) {
                                                setState(() {
                                                  isBusy = false;
                                                });
